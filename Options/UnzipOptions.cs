...
[Verb("unzip", HelpText = "Разархивирует архивы из входной папки в выходную")]
public class UnzipOptions : IOptions
{
    ...
    public Object? Clone() => this.MemberwiseClone() as UnzipOptions;
}
